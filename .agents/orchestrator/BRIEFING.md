...
- Working directory: c:\Users\Usuario\Documents\antigravity\CRM WHATSAPP\.agents\orchestrator
- Original parent: parent
- Original parent conversation ID: eb373ff5-c69e-4dd2-a053-f51bfaf90ff5

## 🔒 My Workflow
- **Pattern**: Project
- **Scope document**: c:\Users\Usuario\Documents\antigravity\CRM WHATSAPP\PROJECT.md
1. **Decompose**: Survey full scope with 3 Explorers, create PROJECT.md, identify milestones.
2. **Dispatch & Execute**:
   - Implementation Track: Milestone execution with Explorer -> Worker -> Reviewer -> Challenger -> Auditor gate loop.
   - E2E Testing Track: Requirements-driven test suite.
...
- Binary veto on Forensic Audit integrity failure.
- Strict tenant isolation and multi-location disk fallback.
